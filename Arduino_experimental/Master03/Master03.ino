...
float roll;
float pitch;
float bodge = 7;  //trim control

int pot;
int BTstate = 0;

double Pk1 = 13;  //speed it gets there
double Ik1 = 0;
double Dk1 = 0.05;
...
// if there's any serial available, read it - this is for the IMU data
  ...
  */
        ...
        //**********Trousers stability PID**************
         ...
         target_pos_trousers = map(ch2, 0,512,-40,40);
...
-
         ...
         easing_drive = 200;          //modify this value for stick smoothing sensitivity
         easing_drive /= 1000;
